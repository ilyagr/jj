...
fn test_git_push_undo() {
    ...
    main: 8c05de152218 (empty) BB
      @origin (ahead by 1 commits, behind by 1 commits): 0cffb6146141 (empty) AA
    "###);
    ...
    main (conflicted):
      ...
      + 0a3e99f08a48 (empty) CC
      + 8c05de152218 (empty) BB
      @origin (behind by 1 commits): 8c05de152218 (empty) BB
    "###);
}
...
fn test_git_push_undo_with_import() {
    ...
    insta::assert_snapshot!(get_branch_output(&test_env, &repo_path), @r###"
    main: 0a3e99f08a48 (empty) CC
      @origin (ahead by 1 commits, behind by 1 commits): 8c05de152218 (empty) BB
    "###);
}
...
fn test_git_push_undo_colocated() {
    ...
    main (conflicted):
      ...
      + 0a3e99f08a48 (empty) CC
      + 8c05de152218 (empty) BB
      @git (behind by 1 commits): 0a3e99f08a48 (empty) CC
      @origin (behind by 1 commits): 8c05de152218 (empty) BB
    "###);
}
