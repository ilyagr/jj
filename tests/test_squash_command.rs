...
fn test_squash() {
    ...
    Parent commit      : 6ca29c9d2e7c (no description set) |b c
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  b9280a9898cb
    ◉  6ca29c9d2e7c b c
    ...
    Working copy now at: e87cf8ebc7e1 (no description set) |c
    Parent commit      : 893c93ae2a87 (no description set) |a b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  e87cf8ebc7e1 c
    ◉  893c93ae2a87 a b
    ...
    Parent commit      : 80960125bb96 (no description set) |e
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  959145c11426
    ◉    80960125bb96 e
...
fn test_squash_partial() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 1 descendant commits
    Working copy now at: f03d5ce4a973 (no description set) |c
    Parent commit      : c9f931cd78af (no description set) |a b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  f03d5ce4a973 c
    ◉  c9f931cd78af a b
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 1 descendant commits
    Working copy now at: e7a40106bee6 (no description set) |c
    Parent commit      : 05d951646873 (no description set) |b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  e7a40106bee6 c
    ◉  05d951646873 b
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 1 descendant commits
    Working copy now at: a911fa1d0627 (no description set) |c
    Parent commit      : fb73ad17899f (no description set) |b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  a911fa1d0627 c
    ◉  fb73ad17899f b
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 1 descendant commits
    Working copy now at: 5e297967f76c (no description set) |c
    Parent commit      : ac2586097a71 (no description set) |b
    "###);
    ...
    "###);
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: 1c4e5596a511 (no description set) |c
    Parent commit      : 16cc94b4efe9 (no description set) |b
    "###);
}
