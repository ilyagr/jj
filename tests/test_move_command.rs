...
fn test_move() {
    ...
    Working copy now at: 1c03e3d3c63f (no description set) |f
    Parent commit      : e9515f21068c (no description set) |e
    ...
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: c8d83075e8c2 (no description set) |f
    Parent commit      : 2c50bfc59c68 (no description set) |e
    "###);
    ...
    Working copy now at: 2b723b1d6033 (no description set) |f
    Parent commit      : 4293930d6333 (no description set) |d e
    "###);
...
fn test_move_partial() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: 71b69e433fbc (no description set) |d
    Parent commit      : 3db0a2f5b535 (no description set) |a
    ...
    let stdout = test_env.jj_cmd_success(&repo_path, &["move", "-i", "--from", "c"]);
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: 63f1a6e96edb (no description set) |d
    Parent commit      : 3db0a2f5b535 (no description set) |a
    Added 0 files, modified 1 files, removed 0 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    ...
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: 17c2e6632cc5 (no description set) |d
    Parent commit      : 3db0a2f5b535 (no description set) |a
    Added 0 files, modified 1 files, removed 0 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    ...
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: b670567d9438 (no description set) |d
    Parent commit      : 3db0a2f5b535 (no description set) |a
    "###);
}
