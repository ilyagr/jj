...
fn test_resolution() {
    ...
    Working copy now at: e069f0736a79 conflict |conflict
...
",
    ...
    insta::assert_snapshot!(
        ...
        @r###"
    Working copy now at: 0bb40c908c8b conflict |conflict
    Parent commit      : aa493daf6659 a |a
    Parent commit      : db6a4daf6ee7 b |b
    Added 0 files, modified 1 files, removed 0 files
...
",
    ...
    insta::assert_snapshot!(
    test_env.jj_cmd_success(&repo_path, &["resolve"]), @r###"
    Working copy now at: 95418cb82ab1 conflict |conflict
    Parent commit      : aa493daf6659 a |a
    Parent commit      : db6a4daf6ee7 b |b
    Added 0 files, modified 1 files, removed 0 files
    "###);
...
fn test_multiple_conflicts() {
    ...
    Working copy now at: 07feb084c0d2 conflict |conflict
    Parent commit      : de7553ef5f05 a |a
    Parent commit      : f68bc2f0a292 b |b
    Added 0 files, modified 1 files, removed 0 files
    After this operation, some files at this revision still have conflicts:
    this_file_has_a_very_long_name_to_test_padding 2-sided conflict
    "###);
    ...
    Working copy now at: ff142405c921 conflict |conflict
    Parent commit      : de7553ef5f05 a |a
    Parent commit      : f68bc2f0a292 b |b
    Added 0 files, modified 1 files, removed 0 files
    "###);
