...
fn test_workspaces_add_second_workspace() {
    ...
    default: e0e6d5672858 (empty) (no description set)
    "###);
    ...
    Working copy now at: 397eac932ad3 (empty) (no description set)
    ...
    insta::assert_snapshot!(stdout, @r###"
    default: e0e6d5672858 (empty) (no description set)
    second: 397eac932ad3 (empty) (no description set)
    "###);
}
...
fn test_workspaces_conflicting_edits() {
    ...
    Working copy now at: fe8f41ed01d6 (empty) (no description set)
    ...
    Working copy now at: a1896a17282f (empty) (no description set)
...
fn test_workspaces_forget() {
    ...
    let stdout = test_env.jj_cmd_success(&main_path, &["workspace", "list"]);
    insta::assert_snapshot!(stdout, @r###"
    secondary: feda1c4e5ffe (empty) (no description set)
    "###);
