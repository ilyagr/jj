...
fn test_rebase_branch() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 2 commits
    Working copy now at: 9ca2a1544e5d e |e
    Parent commit      : 1394f625cbbd b |b
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 2 commits
    Working copy now at: 817e3fb0dc64 e |e
    Parent commit      : 1394f625cbbd b |b
    Added 1 files, modified 0 files, removed 0 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
...
fn test_rebase_branch_with_merge() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 3 commits
    Working copy now at: 391c91a7defa e |e
    Parent commit      : 1677f79555e4 d |d
    Added 1 files, modified 0 files, removed 0 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  e
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 3 commits
    Working copy now at: 040ae3a6d358 e |e
    Parent commit      : 3d0f3644db16 d |d
    Added 1 files, modified 0 files, removed 0 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  e
...
fn test_rebase_single_revision() {
    ...
    Working copy now at: 7e15b97a447f d |d
    Parent commit      : 934236c8090e c |c
    ...
    Working copy now at: bf87078f4560 d |d
    Parent commit      : d370aee184ba b |b
    Parent commit      : 2443ea76b0b1 a |a
    Added 0 files, modified 0 files, removed 1 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @    d
...
fn test_rebase_single_revision_merge_parent() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    Also rebased 1 descendant commits onto parent of rebased commit
    Working copy now at: c62d0789e7c7 d |d
    Parent commit      : d370aee184ba b |b
    Parent commit      : 2443ea76b0b1 a |a
    Added 0 files, modified 0 files, removed 1 files
    "###);
...
fn test_rebase_with_descendants() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 3 commits
    Working copy now at: 309336ffce22 d |d
    Parent commit      : 244fa794aa18 c |c
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  d
    ◉  c
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 2 commits
    Working copy now at: 92c2bc9a8623 d |d
    Parent commit      : 2443ea76b0b1 a |a
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 3 commits
    Working copy now at: f1e71cb78a06 d |d
    Parent commit      : 2443ea76b0b1 a |a
    Added 0 files, modified 0 files, removed 2 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 3 commits
    Working copy now at: d17539f7ea7c d |d
    Parent commit      : 2443ea76b0b1 a |a
    Added 0 files, modified 0 files, removed 2 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
