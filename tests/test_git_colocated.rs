...
fn test_git_colocated_branches() {
    ...
    git_repo
        ...
        .unwrap();
    insta::assert_snapshot!(get_log_output(&test_env, &workspace_root), @r###"
    Working copy now at: 096dc80da670 (empty) (no description set)
    Parent commit      : 230dd059e1b0 (empty) (no description set)
...
fn test_git_colocated_branch_forget() {
    ...
    master: 230dd059e1b0 (empty) (no description set) |master
    "###);
