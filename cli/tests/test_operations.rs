...
fn test_op_summary_diff_template() {
    ...
    insta::assert_snapshot!(&stdout, @"");
    insta::assert_snapshot!(&stderr, @r#"
    Undid operation: [38;5;4m<<operation summary id short::2301f6e6ec31>>[39m<<operation summary:: (>>[38;5;6m<<operation summary time end local format::2001-02-03 08:05:11>>[39m<<operation summary::) >><<operation summary description first_line::new empty commit>>
    "#);
    let stdout = test_env.jj_cmd_success(
        &repo_path,
        &[
    ...
    insta::assert_snapshot!(&stdout, @r#"
    From operation: [38;5;4m<<operation summary id short::000000000000>>[39m<<operation summary:: >>[38;5;2m<<operation summary root::root()>>[39m
      To operation: [38;5;4m<<operation summary id short::d208ae1b4e3c>>[39m<<operation summary:: (>>[38;5;6m<<operation summary time end local format::2001-02-03 08:05:12>>[39m<<operation summary::) >><<operation summary description first_line::undo operation 2301f6e6ec31931a9b0a594742d6035a44c05250d1707f7f8678e888b11a98773ef07bf0e8008a5bccddf7114da4a35d1a1b1f7efa37c1e6c80d6bdb8f0d7a90>>
