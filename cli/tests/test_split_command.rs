...
fn test_split_parallel_with_conflict() {
    ...
    Remaining changes: rlvkpnrz 145f9b24 (conflict) (no description set)
    Working copy  (@) now at: rlvkpnrz 145f9b24 (conflict) (no description set)
    Parent commit (@-)      : qpvuntsm ee8e9376 (no description set)
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict
    New conflicts appeared in 1 commits:
      rlvkpnrz 145f9b24 (conflict) (no description set)
