...
/// readonly.
//
// TODO(ilyagr): Returning the path to the file to be cleaned up is ugly. Put it
// inside either DiffWorkingCopies or a new struct.
...
) -> Result<(DiffWorkingCopies, Option<PathBuf>), DiffEditError> {
